        ...
        children: [
          {
            ...
            text: { content: title, style: "paragraph-sm", weight: 400, color: { token: "color.text-primary" }, editable: true },
          },
          {
            key: "info-subtitle",
            tag: "span",
            ...
            text: { content: subtitle, style: "paragraph-xs", weight: 400, color: { token: "color.text-secondary" }, editable: true },
          },
        ],
      },
    ],
...
export function actionSheetTemplate(props?: Record<string, unknown>): ComponentSpec {
    ...
    children.push({
      ...
      children: [
        ...
        },
        {
          ...
          layout: { display: "inline-flex" },
          style: { letterSpacing: "0.02em", lineHeight: "20px" },
          text: { content: secondaryLabel, style: "label-xl", weight: 400, color: { token: "color.text-primary" }, editable: true },
        },
      ],
    });
  }
  ...
  children.push({
    ...
    children: [{
      ...
      style: { background: { token: "color.surface-button-secondary-black" } },
    }],
  });
