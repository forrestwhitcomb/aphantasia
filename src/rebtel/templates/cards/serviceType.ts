// ============================================================
// Service Type Card — Pixel-perfect from Figma 3.0
// ============================================================
// Figma: 5405:107036 — 358×120
// White bg, radius 16px, padding 16px, vertical flex, gap 12px
...
const ICON_CALLING = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#111111" stroke-width="1.5" stroke-linecap="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 3.07 8.63 2 2 0 0 1 5.11 2h3a2 2 0 0 1 2 1.72c.13.97.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.84.57 2.81.7A2 2 0 0 1 22 16.92z"/></svg>`;
...
export function serviceTypeTemplate(props?: Record<string, unknown>): ComponentSpec {
  ...
  return {
    ...
    children: [
      ...
      // CTA pill: full width, height 40px, grey bg, radius 32px
      {
        key: "cta",
        tag: "div",
        layout: {
