...
> = {
  ...
  flowStepper: { primitive: "selector", template: "tabs" },
  breadcrumb: { primitive: "text", template: "headline-xs" },

  // Content & Data Display
  contactCard: { primitive: "card", template: "contact" },
  rateCard: { primitive: "row", template: "rate" },
  topUpCard: { primitive: "card", template: "product-credits" },
  ...
  carrierBadge: { primitive: "text", template: "label-md" },
  ...
  label: { primitive: "text", template: "label-pill" },
  ...
  rebtelProfileHeader: { primitive: "card", template: "blank" },
  ...
  emptyState: { primitive: "status", template: "loading" },
  alert: { primitive: "text", template: "paragraph-md" },
  toast: { primitive: "text", template: "paragraph-md" },
