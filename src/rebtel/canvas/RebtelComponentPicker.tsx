...
const REBTEL_CATEGORIES: RebtelCategory[] = [
  {
    name: "Top Up",
    items: [
      { type: "topUpCard", label: "Top-Up Card", defaultWidth: 353, defaultHeight: 200 },
      ...
      { type: "paymentMethod", label: "Payment Method", defaultWidth: 353, defaultHeight: 80 },
  ...
  },
  {
    name: "Calling",
    items: [
      { type: "contactCard", label: "Contact Card", defaultWidth: 353, defaultHeight: 80 },
      { type: "rateCard", label: "Rate Card", defaultWidth: 353, defaultHeight: 72 },
      { type: "phoneInput", label: "Phone Input", defaultWidth: 353, defaultHeight: 56 },
  ...
  },
  {
    name: "Home & Nav",
    items: [
      { type: "appBar", label: "App Bar", defaultWidth: 393, defaultHeight: 56 },
      { type: "rebtelTabBar", label: "Tab Bar", defaultWidth: 393, defaultHeight: 56 },
      { type: "balanceWidget", label: "Balance Widget", defaultWidth: 353, defaultHeight: 120 },
      { type: "promoCard", label: "Promo Card", defaultWidth: 353, defaultHeight: 120 },
      { type: "homeScreen", label: "Home Screen", defaultWidth: 393, defaultHeight: 600 },
      { type: "segmentedNav", label: "Segmented Nav", defaultWidth: 353, defaultHeight: 40 },
    ],
  },
  {
    name: "Settings",
    items: [
      { type: "rebtelProfileHeader", label: "Profile Header", defaultWidth: 393, defaultHeight: 160 },
      { type: "settingsGroup", label: "Settings Group", defaultWidth: 393, defaultHeight: 250 },
      { type: "breadcrumb", label: "Breadcrumb", defaultWidth: 353, defaultHeight: 32 },
      { type: "onboardingFlow", label: "Onboarding Flow", defaultWidth: 393, defaultHeight: 500 },
  ...
  },
  {
    ...
    items: [
      ...
      { type: "countryRow", label: "Country Row", defaultWidth: 393, defaultHeight: 56 },
      { type: "carrierBadge", label: "Carrier Badge", defaultWidth: 120, defaultHeight: 32 },
      { type: "flowStepper", label: "Flow Stepper", defaultWidth: 353, defaultHeight: 60 },
