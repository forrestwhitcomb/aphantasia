...
- Always use semantic design tokens defined.
...
- Reference and context from reference and context cards
```
...
- Use only semantic tokens from css and tailwind config
...
- ❌ Generate sites with hardcoded colors unless explicity stated by user (`text-blue-500`, `bg-gray-100`)
